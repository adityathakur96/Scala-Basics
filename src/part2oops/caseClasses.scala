...
// 2. sensible toString
 ...
 // it create the new instance of this case class also copy method can get named parameter
  println(jim3)
  
  // 5. case classes have companion objects 
  val thePerson= Person
 // as i have used case here then compiler will automatically make the companion object for this class therefore then here Person is companion object
  val marry= Person("marry",23)
 // we can call this companion object as apply method for the class
